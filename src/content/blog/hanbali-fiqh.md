...
*Al-Wasit* by al-Ghazali should be studied. It is one of the greatest mutun authored in any madhhab by the way it was written, and al-Nawawi is said to have read hundreds of times. Although it is largely an abridgement of *Nihayat al-Matlab*, al-Ghazali presents his own opinions throughout the book as well. For more detail, reference *Sharh al-'Aziz* by al-Rafi'i. The author had a habit of picking up useful ideas from *Nihayat al-Matlab* that al-Ghazali left out of *al-Wasit*. When he got a hold of this book, Ibn Daqiq al-'Id is said to have stuck to only praying the fara'id until he finished reading it. Also reference *al-Awsat* by Ibn al-Mundhir, who was an independent jurist in his own right and relied upon by Ibn Qudamah in *al-Mughni*. 
