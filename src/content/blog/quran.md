...
# Elementary Level
At this stage, one should set a dedicated time to study each week, sticking to a routine and remaining consistent. A manageable amount is to read half a juz' a week, or the tafsir of a page from the mushaf each day. This way, one will have completed a full tafsir of the Qur'an in a year. Studying nahw with the intention of mastering i'rab as early as possible is important at this level. 
...
At this point, listen to Ali Hani’s series *Al-Tariqat Al-Muthla*, which is a brief introduction on how tafsir is performed. Also read *Akhlaq Hamalat al-Qur'an* by Abu Bakr al-Ajurri, a short book and one of the earliest sources to gather to required manners and characters bearers of the Qur'an.
...
Another excellent choice for this level is *Tafsir Ibn Juzayy*, which largely relies on *al-Muharrar al-Wajiz* by Ibn 'Attiyah and *al-Kashshaf* by al-Zamakhshari. Ibn Juzayy was an excellent writer and his tafsir is preferred in North and West Africa. He does not comment on everything, so a teacher must fill in the gaps. Ensure the edition you are reading uses the qira'ah of Nafi', which is what the author based this work on. His muqaddimat are also important; Musa'id al-Tayyar has a commentary on them which should also be read. 

- *Al-Muqaddimat Al-Jazariyyah* by Ibn al-Jazari

Before studying this poem, listen to Musa Abu Zaghleh's recorded series on tajwid. It should be read with its commentary by Ghanim Quduri al-Hamad, which consolidates over a dozen classical and contemporary works on the *Jazariyyah*. Keep in mind that tajwid can only be mastered through continuous practice, listening, and correction. 

- *Al-Muyassar fi-'Ilm 'Add Ayy al-Qur'an* by Ahmad Khalid Shukri

Most ayah endings are obvious but a degree of ambiguity arises in certain places, leading to khilaf. These issues are dealt with in ‘ilm ’add al-ayi, for which Sh. Ali Hani highly recommends studying this work by Ahmad Shukri. 

- *Al-Muyassar fi-'Ilm Rasm al-Mushaf* by by Ghanim Qadduri al-Hamad
...
At this stage, one begins to move from having a general understanding of each ayah to applying usul al-tafsir, which includes causes of different opinions, categories of interpretation, principles of interpretation, rules of giving tarjih, knowing the nomenclature of the mufassirin, various qira’at, causes of revelation, and abrogation. The Qur'an cannot be studied up to a certain point without also studying qira'at and tajwid in detail. Qira'at in particular have a heavy role in tafsir, though they do not need to necessarily be memorized. However, if someone wants to master qira'at, he should study works on qira'at, rasm, and 'add, then find a good muqri' to read to.
...
For an overview of the meanings of specific words in the Qur’an, reference *Kulliyat al-Alfadh* by al-Qarni and *Gharib al-Quran* by Ibn Qutaybah, which is a highly influential work that was quoted by many of the classical mufassirin including al-Tabari, al-Qurtubi, and al-Razi. It is relatively brief and the best place to begin looking for the meaning of ambiguous words. 
...
- *Ahkam al-Qur’an* by Abu Bakr b. al-’Arabi

Out of all of those who authored a book on the topic of rulings in the Qur’an, Ibn ‘Arabi had the most mastery of the various ulum.
...
- *Al-Muqni'* by Abu 'Amr al-Dani

This is an important classical work on the rasm and differences between the masahif.

- *Al-Masahif* by Ibn Abi Dawud

At this point, this book is crucial to read because it contains important information about the early history of the Qur'an, including problematic reports that need further explanation. Listening to Musa’id al-Tayyar’s *Tarikh al Qur'an* recordings before reading *al-Masahif* will give you a framework to analyze and interpret those narrations. Next, read *Fada'il al-Qur'an* by Abu 'Ubayd al-Qasim, who is one of the most important scholars of the Qur'an in history. His khidmah to the Qur'an has makes him a key link for much of what is known about it today.
...
This book is concerned with the history of ahruf and qira'at. It is one of the most important works to read in order to understand the topic. Supplement this by reading *Ma’ani al-Ahruf al-Sab’ah* by ‘Abd al-Rahman al-Razi and *Al-Murshid Al-Wajiz* by Abu Shamah to gain a comprehensive view of the various opinions. Also read the sections relevant to the seven ahruf from *Fath al-Bari by Ibn Hajar*, *Sharh Mushkil al-Athar* by al-Tahawi, *al-Tamhid* by Ibn 'Abd al-Barr. *Masa'il al-Qira'at* by al-Qijati is another important work to read.
...
In this book, Ibn Abi Talib gives his own ikhtiyar between the readings of the seven on every issue. This will give one a glimpse into the process of ikhtiyar and the reasoning involved in it. Abu Ubayd and Abu Hatim both wrote important early works on qira'at which Makki had access to, and he frequently cites their ikhtiyar in *Kashf*. He also quotes from the lost works of al-Tabari and Qadi Isma'il. Supplement this with *Qawa’id al-Tarjih wa’l-Ikhtiyar* by Yahya Jalal, in which he identifies Ibn Abi Talib’s qawa’id for ikhtiyar, along with *Sharh al-Hidayah* by al-Mahdawi and *Al-Badi’* by Ibn Matrif al-Kinani, which are also excellent works on tawjih. 
...
- *Miftah al-Ghayb* by Fakhr al-Din al-Razi
